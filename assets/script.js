...
function setupAnalytics() {
    // Load Director Dashboard first
    loadDirectorDashboard();
    
    const mainPanel = document.getElementById('analytics-content');
    const analyticsMainContainer = document.getElementById('analytics-main');
    const employeeList = document.getElementById('employee-list');
    const periodSelector = document.querySelector('.analytics-period-selector');
    const analyticsPanel = document.getElementById('analytics-panel');
    
    if (!mainPanel || !employeeList || !periodSelector || !analyticsPanel || !analyticsMainContainer) return;
